...
public class S2_SpringJDBCExample {
	
	/**
	 * let's change the way of thinking:
	 * if I need a dependency  I will not go and create it my self with a new = Class();
	 * I will let spring handle the dependency and give it to me
	 */
